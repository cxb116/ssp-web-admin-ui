/** ========== SSP - 广告模块 ========== */
const SSP_DICT = {
  SSP_ENABLE: 'ssp_enable', // 广告状态
  SSP_AD_SIZE: 'ssp_ad_size', // 广告尺寸
  SSP_AD_SCENE: 'ssp_ad_scene', // 广告场景
  SSP_PAY_TYPE: 'ssp_pay_type', // 结算方式
  SSP_OS_TYPE: 'ssp_os_type', // 操作系统类型
  SSP_ACCESS_TYPE: 'ssp_access_type', // 接入方式
  SSP_TRAFFIC_TYPE: 'ssp_traffic_type', // 流量类型

  SSP_REQUEST_TYPE: 'ssp_request_type', // 请求类型
} as const;
